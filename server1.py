...
strategies1 = [strategy.QFedAvg, strategy.FedAvg, strategy.FaultTolerantFedAvg]
# 需要初始化模型参数
strategies2 = [strategy.FedAdagrad, strategy.FedAdam]
strategy_choose = strategy.FedAvg


class SaveModelStrategy(strategy_choose):
...
if strategy_choose in strategies1:
